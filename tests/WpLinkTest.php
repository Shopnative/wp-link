...
final class WpLinkTest extends TestCase
{
    ...
    public function testTargetExternal()
    {
        ...
        foreach ([
            ...
            // Http
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://external.com/foo/bar.html?q=narf'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://subdomain.external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://subdomain.external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://subdomain.external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://subdomain.external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('http://subdomain.external.com/foo/bar.html?q=narf'));

            // Https
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://external.com/foo/bar.html?q=narf'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://subdomain.external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://subdomain.external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://subdomain.external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://subdomain.external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('https://subdomain.external.com/foo/bar.html?q=narf'));

            // External Same Scheme
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//external.com/foo/bar.html?q=narf'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//subdomain.external.com'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//subdomain.external.com/'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//subdomain.external.com/foo'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//subdomain.external.com/foo/bar.html'));
            $this->assertEquals('target="_blank" rel="noopener"', WpLink::target('//subdomain.external.com/foo/bar.html?q=narf'));
        }
    }
    ...
    public function testContentFilter()
    {
        ...
        foreach ([
            ...
            $this->assertEquals('<a href="http://external.com" target="_blank" rel="noopener">link</a>', WpLink::content('<a href="http://external.com">link</a>'));
            ...
            $this->assertEquals('<p>First <a href="http://external.com/" target="_blank" rel="noopener">link</a>.</p><p>Second <a href="http://external.com/about" target="_blank" rel="noopener">link</a>.</p>',
            ...
            $this->assertEquals('<div class="foo">Some text <em>with <strong>a <a class="link" id="test" href="http://external.com/" target="_blank" rel="noopener">link</a> and</strong> more</em> text</div>',
            ...
            $this->assertEquals('<a href="http://external.com" target="_blank" rel="noopener">link</a>', WpLink::content('<a href="http://external.com" target="_blank" rel="noopener">link</a>'));
